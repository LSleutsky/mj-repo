  ...
  <header class="wrapper clearfix">
      ...
      <div class="menu-toggle">Menu</div>  
        <ul class="srt-menu" id="menu-main-navigation">
          ...
          <li><a href="insurance.php" class="selected">Insurance</a></li>
...
<!--       <h1 style="text-decoration: underline">Office</h1>
        ...
        <p class="para office_email">Email: MJRepo@Comacst.net</p>
                  
      <h1 style="text-decoration: underline">Address</h1>
        <p class="para">P.O. Box 563<br>Huntingdon Valley, PA 19006</p> -->

      <h1 class="title2" style="text-align: center; text-decoration: underline">License & Insurance</h1>
        <ul class="imageGallery">
         <li><a href="images/PA_License.jpg"><img src="images/PA_License.jpg" width="400" alt="PA State License"></a></li>
        </ul>
        <ul class="imageGallery">
          <li><a href="images/PA_License_2.jpg"><img src="images/PA_License_2.jpg" width="350" alt="PA Repossession and Recovery License"></a></li>
         <li><a href="images/PA_Certificate.jpg"><img src="images/PA_Certificate.jpg" width="350" alt="PA Repossession and Recovery Certificate"></a></li>
