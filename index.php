  ...
  <!-- content area -->    
    <section id="content">
      ...
      <h2>Availability & Reliability</h2>
        <p class="para">MJ Repo Services has been located in the heart of Philadelphia for many years, allowing us to reliably service Philly and the surrounding suburbs <em>(Bucks, Montgomery, Delaware, & Chester Counties)</em>, extending into New Jersey <em>(Mercer, Burlington, Camden, Gloucester, Cumberland & Salem Counties)</em>, and Delaware <em>(New Castle County)</em> .</p>

        <div class="service_holder">  
          <img class="service_truck" src="images/trucks.jpg" width="450px" alt="MJ Repo Services tow truck parked in a parking lot">
        </div>
                  
      <h2 style="clear: both">Cutting Edge & Secure</h2>
        <p class="para">Our recovery vehicles use modern, state-of-the-art equipment. MJ Repo Vehicles have cameras, laptops, and printers onboard. Repossession and recovery orders may be printed immediately. Our storage facilities are equipped with a multitude of high tech cameras, and the entire property is heavily gated.</p>

        <div class="service_holder">
          <img class="service_truck two_trucks" src="images/security.jpg" style="width: 450px" alt="MJ Repo Services company lights and security cameras">
        </div>
                  
      <h2>Trust & Experience</h2>
        <p class="para">Customers can contact our office and pick up their automobiles between the hours of 9AM to 5PM, Monday through Friday. MJ tries hard to be available for pick ups after hours, and will always do our best to accomodate your time frame, if notified ahead of time.</p>
        <div class="service_holder">  
          <img class="service_truck" src="images/truck_8.png" width="450px" alt="MJ Repo Services tow truck dropping off a car">
        </div>
